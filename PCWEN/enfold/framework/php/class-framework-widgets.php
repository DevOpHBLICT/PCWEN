	...
	class avia_socialcount extends WP_Widget {
		...
		function widget($args, $instance) {
			...
			if(!empty($twitter) || !empty($rss))
			{
				...
				if($rss)
				{
					$output .= "<a href='$rss' class='asc_rss $addClass'>".apply_filters('avf_social_widget',"", 'rss')."<strong class='asc_count'>".__('Follow','avia_framework')."</strong><span>".__('on LinkedIn','avia_framework')."</span></a>";
				}
