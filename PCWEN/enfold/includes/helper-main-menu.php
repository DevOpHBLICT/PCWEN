					...
					$output .= "<div class='inner-container'>";
						...
						*/
						    ...
						    { 
								...
								$output .= "<span id='header_main_alternate'><img height='30px' style='float:right;position: absolute;top: 0px;right: 0px;' src='" . AVIA_BASE_URL . "images/layout/nhs_logo_clr.png'></span> ";
